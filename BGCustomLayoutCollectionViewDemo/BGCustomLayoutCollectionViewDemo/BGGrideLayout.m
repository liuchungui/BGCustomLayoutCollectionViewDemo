...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //每一组cell为一行
    attributes.frame = CGRectMake(self.contentInset.left + (self.itemSize.width + self.interitemSpacing) * indexPath.row + self.interitemSpacing, self.contentInset.top + (self.itemSize.height + self.lineSpacing) * indexPath.section + self.lineSpacing, self.itemSize.width, self.itemSize.height);
    return attributes;
}
